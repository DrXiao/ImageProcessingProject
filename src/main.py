...
def main():
    ...
    readVideo_RGB('movie/effect_quokka.mp4')
    readVideo_T0('movie/effect_T0.mp4')
    # readVideo_edgeDetection(f'movie/effect_edgeDetection.mp4')
    # readVideo_remove_point('movie/effect_addg.mp4')
